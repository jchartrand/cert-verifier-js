...
const getRegisteredIssuerIds = 'getRegisteredIssuerIds'
...
const subStepsMap = {
  ...
  [STEPS.statusCheck]: [getRegisteredIssuerIds, checkIssuerIdentity, checkIssuerSignature, checkAuthenticity, checkRevokedStatus, checkExpiresDate]
};
